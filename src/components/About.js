        ...
        <div className="home">
            ...
            <div className="info-about">
                ...
                <div>
                    <h2>About Me</h2>
                    <p align="justify">
                    Since I started learning programming, I have work with many languages and frameworks like: C, C#, Entity Framework, PHP, Laravel, Python, Django, Django Rest Framework.
                    But currently I'm mainly focused on web development and mobile applications with Javascript,
                    Python and the basis of Java, all of these mainly focused on backend development. You can see my general and specific knowledge in the following cards.
                    ...
                    <p>GMAIL: <b>edvincv13@gmail.com</b></p>
                </div>
            </div>
